 ...
 * Use the {@link OnDeliveryFragment#newInstance} factory method to
...
public class OnDeliveryFragment extends Fragment {
    ...
    public static OnDeliveryFragment newInstance(String param1, String param2) {
        OnDeliveryFragment fragment = new OnDeliveryFragment();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recyclerOnDelivery);
    ...
    private void loadOnDeliveryOrder() {
        mDatabase = FirebaseDatabase.getInstance().getReference("Orders");
        ...
        orderQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot orderSnapshot : snapshot.getChildren()) {
                    ...
                    if (order != null && "On Delivery".equals(order.getOrderStatus())) {
                        orders.add(order);
                    }
                }
                ...
                orderAdapter.setOnItemClickListener(new OrderAdapter.OrderAdapterListener() {
                    ...
                    public void onItemClicked(Order order) {
                        if (order != null && order.getOrderId() != 0) {
                            Log.d("OnDeliveryFragment", "orderId: " + order.getOrderId());

                            Intent intent = new Intent(getActivity(), ViewOrderUserActivity.class);
                            intent.putExtra("orderId", String.valueOf(order.getOrderId()));

                            startActivity(intent);
                        } else {
                            Log.e("OnDeliveryFragment", "Order or orderId is null");
                        }
                    }
                });
